...
export const getSalePaymentInfo = asyncHandler(async (req, res) => {
  ...
  // NOTE: `payments` now includes the upfront advance as its own row (see
  // completeSale/editSale), so it already accounts for sale.paid_amount —
  // adding sale.paid_amount again here would double-count that advance.
