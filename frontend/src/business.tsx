...
export function BusinessProvider({children}:{children:ReactNode}) {
  ...
  return <BusinessContext.Provider value={{...state,add,update,remove,removeListItem,completeSale,addPurchase,recordPayment,recordSupplierPayment,editSale,recordSalePayment,removeSale,payPurchaseInvoice,reset,updateSettings}}>{children}</BusinessContext.Provider>;
}
